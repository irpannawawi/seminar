                    ...
                    <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="demosMegaMenu" style="min-width: 40rem;">
                        ...
                        <div class="navbar-dropdown-menu-promo">
                            ...
                            <div class="navbar-dropdown-menu-promo-item">
                                <!-- Promo Link -->
                                <a class="navbar-dropdown-menu-promo-link active" href="<?= base_url('assets/frontend/') ?>index.html">
                                    <div class="d-flex">
                            ...
                            <div class="navbar-dropdown-menu-promo-item">
                                <!-- Promo Link -->
                                <a class="navbar-dropdown-menu-promo-link " href="<?= base_url('assets/frontend/') ?>demo-real-estate/index.html">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <span class="svg-icon svg-icon-sm text-primary">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="navbar-dropdown-menu-promo-item">
                                <!-- Promo Link -->
                                <a class="navbar-dropdown-menu-promo-link " href="<?= base_url('assets/frontend/') ?>demo-jobs/index.html">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <span class="svg-icon svg-icon-sm text-primary">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="navbar-dropdown-menu-promo">
                            ...
                            <div class="navbar-dropdown-menu-promo-item">
                                <!-- Promo Link -->
                                <a class="navbar-dropdown-menu-promo-link " href="<?= base_url('assets/frontend/') ?>demo-course/index.html">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <span class="svg-icon svg-icon-sm text-primary">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="navbar-dropdown-menu-promo-item">
                                <!-- Promo Link -->
                                <a class="navbar-dropdown-menu-promo-link " href="<?= base_url('assets/frontend/') ?>demo-shop/index.html">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <span class="svg-icon svg-icon-sm text-primary">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="navbar-dropdown-menu-promo-item">
                                <!-- Promo Link -->
                                <a class="navbar-dropdown-menu-promo-link " href="<?= base_url('assets/frontend/') ?>demo-app-marketplace/index.html">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <span class="svg-icon svg-icon-sm text-primary">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="navbar-dropdown-menu-promo">
                            ...
                            <div class="navbar-dropdown-menu-promo-item">
                                <!-- Promo Link -->
                                <a class="navbar-dropdown-menu-promo-link " href="<?= base_url('assets/frontend/') ?>demo-help-desk/index.html">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <span class="svg-icon svg-icon-sm text-primary">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="hs-has-mega-menu nav-item" data-hs-mega-menu-item-options='{
                  "desktop": {
                    ...
                    <div class="hs-mega-menu hs-position-right dropdown-menu" aria-labelledby="docsMegaMenu" style="min-width: 20rem;">
                        <!-- Link -->
                        <a class="navbar-dropdown-menu-media-link" href="<?= base_url('assets/frontend/') ?>documentation/index.html">
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <span class="svg-icon svg-icon-sm text-primary">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Link -->
                        <a class="navbar-dropdown-menu-media-link" href="<?= base_url('assets/frontend/') ?>snippets/index.html">
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <span class="svg-icon svg-icon-sm text-primary">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="container">
    <nav class="js-mega-menu navbar-nav-wrap">
        <!-- Default Logo -->
        <a class="navbar-brand" href="<?= base_url('assets/frontend/') ?>index.html" aria-label="Front">
            <img class="navbar-brand-logo" src="<?= base_url('assets/frontend/') ?>svg/logos/logo.svg" alt="Logo">
        </a>
        <!-- End Default Logo -->
                ...
                <ul class="navbar-nav">
                        ...
                        <div class="hs-mega-menu dropdown-menu w-100" aria-labelledby="landingsMegaMenu" style="min-width: 30rem;">
                            <div class="row">
                                <div class="col-lg-6 d-none d-lg-block">
                                    <!-- Banner Image -->
                                    <div class="navbar-dropdown-menu-banner" style="background-image: url(<?= base_url('assets/frontend/') ?>svg/components/shape-3.svg);">
                                    ...
                                    <div class="navbar-dropdown-menu-inner">
                                        <div class="row">
                                            <div class="col-sm mb-3 mb-sm-0">
                                                ...
                                                <a class="dropdown-item active" href="<?= base_url('assets/frontend/') ?>landing-classic-corporate.html">Corporate</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-analytics.html">Analytics <span class="badge bg-primary rounded-pill ms-1">Hot</span></a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-studio.html">Studio</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-marketing.html">Marketing</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-advertisement.html">Advertisement</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-consulting.html">Consulting</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-portfolio.html">Portfolio</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-software.html">Software</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-classic-business.html">Business</a>
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="col-sm">
                                                <div class="mb-3">
                                                    ...
                                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-app-ui-kit.html">UI Kit</a>
                                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-app-saas.html">SaaS</a>
                                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-app-workflow.html">Workflow</a>
                                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-app-payment.html">Payment</a>
                                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-app-tool.html">Tool</a>
                                                </div>

                                                <span class="dropdown-header">Onepage</span>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-onepage-corporate.html">Corporate</a>
                                                <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>landing-onepage-saas.html">SaaS <span class="badge bg-primary rounded-pill ms-1">Hot</span></a>
                                            </div>
                                            <!-- End Col -->
                                        </div>
                                        <!-- End Row -->
                    ...
                    <li class="hs-has-sub-menu nav-item">
                        ...
                        <div class="hs-sub-menu dropdown-menu" aria-labelledby="companyMegaMenu" style="min-width: 14rem;">
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-about.html">About</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-services.html">Services</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-customer-stories.html">Customer Stories</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-customer-story.html">Customer Story</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-careers.html">Careers</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-careers-overview.html">Careers Overview</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-hire-us.html">Hire Us</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-pricing.html">Pricing</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-contacts-agency.html">Contacts: Agency</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-contacts-startup.html">Contacts: Startup</a>
                        </div>
                        <!-- End Mega Menu -->
                    </li>
                    <!-- End Company -->
                        ...
                        <div class="hs-sub-menu dropdown-menu" aria-labelledby="accountMegaMenu" style="min-width: 14rem;">
                            ...
                            <div class="hs-has-sub-menu nav-item">
                                ...
                                <div class="hs-sub-menu dropdown-menu" aria-labelledby="authenticationMegaMenu" style="min-width: 14rem;">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-login.html">Login</a>
                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-signup.html">Signup</a>
                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-reset-password.html">Reset Password</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-login-simple.html">Login Simple</a>
                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-signup-simple.html">Signup Simple</a>
                                    <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-reset-password-simple.html">Reset Password Simple</a>
                                </div>
                            </div>
                            <!-- End Authentication -->

                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-overview.html">Personal Info</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-security.html">Security</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-notifications.html">Notifications</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-preferences.html">Preferences</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-orders.html">Orders</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-wishlist.html">Wishlist</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-payments.html">Payments</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-address.html">Address</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>account-teams.html">Teams</a>
                        </div>
                        <!-- End Mega Menu -->
                    </li>
                    <!-- End Account -->
                    ...
                    <li class="hs-has-sub-menu nav-item">
                        ...
                        <div class="hs-sub-menu dropdown-menu" aria-labelledby="pagesMegaMenu" style="min-width: 14rem;">
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-faq.html">FAQ</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-terms.html">Terms &amp; Conditions</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-privacy.html">Privacy &amp; Policy</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-coming-soon.html">Coming Soon</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-coming-soon-simple.html">Coming Soon: Simple</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-maintenance-mode.html">Maintenance Mode</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-status.html">Status</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-invoice.html">Invoice</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>page-error-404.html">Error 404</a>
                        </div>
                        <!-- End Mega Menu -->
                    </li>
                    <!-- End Pages -->
                    ...
                    <li class="hs-has-sub-menu nav-item">
                        ...
                        <div class="hs-sub-menu dropdown-menu" aria-labelledby="blogMegaMenu" style="min-width: 14rem;">
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>blog-journal.html">Journal</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>blog-metro.html">Metro</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>blog-newsroom.html">Newsroom</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>blog-article.html">Article</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>blog-author-profile.html">Author Profile</a>
                        </div>
                        <!-- End Mega Menu -->
                    </li>
                    <!-- End Blog -->
                    ...
                    <li class="hs-has-sub-menu nav-item">
                        ...
                        <div class="hs-sub-menu dropdown-menu" aria-labelledby="portfolioMegaMenu" style="min-width: 14rem;">
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>portfolio-grid.html">Grid</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>portfolio-product-article.html">Product Article</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>portfolio-case-studies-branding.html">Case Studies: Branding</a>
                            <a class="dropdown-item " href="<?= base_url('assets/frontend/') ?>portfolio-case-studies-product.html">Case Studies: Product</a>
                        </div>
                        <!-- End Mega Menu -->
                    </li>
                    <!-- End Portfolio -->
                    ...
                    <!-- Button -->
                    <li class="nav-item">
                        <a class="btn btn-primary btn-transition" href="https://themes.getbootstrap.com/product/front-multipurpose-responsive-template/" target="_blank">Login/Daftar</a>
                    </li>
                    <!-- End Button -->
                </ul>
            </div>
