                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="d-grid d-sm-flex gap-3">
                            <a class="btn btn-primary btn-transition px-6" href="<?= base_url('assets/frontend/') ?>page-login-simple.html">Get started</a>
            ...
            <div class="col-lg-7 col-xl-6 d-none d-lg-block position-absolute top-0 end-0 pe-0" style="margin-top: 6.75rem;">
              ...
              c0.7,4.7,1.2,9.5,1.7,14.2l29.3,321c14,154.2,150.6,267.8,304.9,253.8L565.5,957.4z" />
                    ...
                    <g transform="matrix(1 0 0 1 0 0)" clip-path="url(#mainHeroSVG2)">
                        <image width="750" height="750" xlink:href="<?= base_url('assets/frontend/') ?>img/750x750/img2.jpg" transform="matrix(1.4462 0 0 1.4448 52.8755 0)"></image>
                    </g>
                </svg>
            </div>
            <!-- End SVG Shape -->
        ...
        <div class="row mb-5 mb-md-0">
            <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                ...
                <div class="card card-sm h-100">
                    <div class="p-2">
                        <img class="card-img" src="<?= base_url('assets/frontend/') ?>img/480x220/img1.jpg" alt="Image Description">
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                ...
                <div class="card card-sm h-100">
                    <div class="p-2">
                        <img class="card-img" src="<?= base_url('assets/frontend/') ?>img/480x220/img2.jpg" alt="Image Description">
                    </div>
            ...
            <div class="col-sm-6 col-lg-4">
                ...
                <div class="card card-sm h-100">
                    <div class="p-2">
                        <img class="card-img" src="<?= base_url('assets/frontend/') ?>img/480x220/img3.jpg" alt="Image Description">
                    </div>
        ...
        <div class="container content-space-2 content-space-lg-3">
            ...
            <div class="row">
                    ...
                    <div class="pe-lg-6">
                        ...
                        <figure class="device-browser">
                            ...
                            <div class="device-browser-frame">
                                <img class="device-browser-img" src="<?= base_url('assets/frontend/') ?>img/1618x1010/img6.jpg" alt="Image Description">
                            </div>
                        </figure>
                        <!-- End Browser Device -->
                    </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="row">
                        <div class="col py-3">
                            <img class="avatar avatar-4x3" src="<?= base_url('assets/frontend/') ?>svg/brands/fitbit-dark.svg" alt="Logo">
                        </div>
                        <!-- End Col -->

                        <div class="col py-3">
                            <img class="avatar avatar-4x3" src="<?= base_url('assets/frontend/') ?>svg/brands/forbes-dark.svg" alt="Logo">
                        </div>
                        <!-- End Col -->

                        <div class="col py-3">
                            <img class="avatar avatar-4x3" src="<?= base_url('assets/frontend/') ?>svg/brands/mailchimp-dark.svg" alt="Logo">
                        </div>
                        <!-- End Col -->

                        <div class="col py-3">
                            <img class="avatar avatar-4x3" src="<?= base_url('assets/frontend/') ?>svg/brands/layar-dark.svg" alt="Logo">
                        </div>
                        <!-- End Col -->
                    </div>
                    <!-- End Row -->
    ...
    <div class="container content-space-2 content-space-lg-3">
        <div class="row align-items-md-center">
            <div class="col-md-5 d-none d-md-block">
                <img class="img-fluid rounded-2" src="<?= base_url('assets/frontend/') ?>img/400x500/img31.jpg" alt="Image Description">
            </div>
            <!-- End Col -->
            ...
            <div class="col-md-7">
                ...
                <figure class="pe-md-7">
                    <div class="mb-4">
                        <img class="avatar avatar-xl avatar-4x3" src="<?= base_url('assets/frontend/') ?>svg/brands/mailchimp-primary.svg" alt="Image Description">
                    </div>
                    ...
                    <figcaption class="blockquote-footer">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 d-md-none">
                                <img class="avatar avatar-circle" src="<?= base_url('assets/frontend/') ?>img/160x160/img4.jpg" alt="Image Description">
                            </div>
            ...
            <div class="row gx-lg-7">
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <a class="card card-flush h-100" href="#" data-aos="fade-up">
                        <img class="card-img" src="<?= base_url('assets/frontend/') ?>img/480x320/img33.jpg" alt="Image Description">
                        <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <a class="card card-flush h-100" href="#" data-aos="fade-up" data-aos-delay="150">
                        <img class="card-img" src="<?= base_url('assets/frontend/') ?>img/480x320/img34.jpg" alt="Image Description">
                        <div class="card-body">
                            <span class="card-subtitle text-body">Read the blog</span>
                ...
                <div class="col-sm-6 col-lg-4 mb-5">
                    ...
                    <a class="card card-flush h-100" href="#" data-aos="fade-up" data-aos-delay="200">
                        <img class="card-img" src="<?= base_url('assets/frontend/') ?>img/480x320/img35.jpg" alt="Image Description">
                        <div class="card-body">
