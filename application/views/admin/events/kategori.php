        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <div class="float-right">
                    ...
                    <a class="btn btn-info" href="javascript:;" data-toggle="modal" data-target="#addModal"><i class="far fa-calendar-plus"></i> Buat Category</a>
                </div>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                                ...
                                foreach ($category as $key) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button onclick="confirmDelete('<?= base_url('admin/events/deleteCategory/' . $key['id_category']); ?>')" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Delete</button>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
